...
const manifest: AppLocalizationManifest = {
  ...
  "messages": {
    "en": {
      ...
      "onboarding.onboarding.company.desc": "Complete company data as the foundation for GroApp integration.",
      ...
      "onboarding.onboarding.welcome.page_title": "Welcome to GroApp Access",
      ...
      "user.email_aktifkan_pengguna.subject": "GroApp: Your Access in {{Company Name}} Has Been Restored",
      "user.invite_email.subject": "GroApp Invitation: Join {{company_name}}",
    ...
    "id": {
      ...
      "onboarding.onboarding.company.desc": "Lengkapi data perusahaan sebagai fondasi integrasi GroApp.",
      ...
      "onboarding.onboarding.welcome.page_title": "Selamat Datang di GroApp Access",
      ...
      "user.email_aktifkan_pengguna.subject": "GroApp: Akses Anda di {{Nama Perusahaan}} Diaktifkan Kembali",
      "user.invite_email.subject": "Undangan GroApp: Bergabung ke {{company_name}}",
